...
I built one of our most complex features - 

[learning machines](https://x.com/ashpreetbedi/status/2010781132418064750)

 - in 5 days. 100% of the code was written by claude code. This would've taken months before.

Context: I'm building 

[Agno](https://agno.link/gh)

, an open-source multi-agent runtime. Agno is a performance-critical application with a lot of moving parts: agent loop, database integrations, vector store integrations, toolkits, runtime with per-request isolation, multi-agent orchestration (autonomous: teams and programmatic: workflows).

Until November 2025, coding agents couldn't handle the codebase. Then Opus 4.5 and Claude Code changed that.

Now I'm building Agno v3 entirely using claude code.
...
[design.md](//design.md)
 ...
 is the source of truth. Claude and I align on the details before development starts. No spec, no implementation.

[implementation.md](//implementation.md)

 tracks progress - what's done, what's blocked. Claude updates this as we go. This is crucial for session continuity: when we hit context limits and need to restart, Claude picks up where it left off.

[decisions.md](//decisions.md)

 captures the "why". I think people are calling these decision traces now - it's how the agent (and future me) knows why we chose one approach over another. This is also where I weigh in on important calls.
...
[prompts.md](//prompts.md)
 ...
 stores reusable prompts to Re-sync design docs with the codebase. Refine and review. Test after a new implementation. Common tasks become copy-paste.

[future-work.md](//future-work.md)

 captures what's deferred. Ideas worth revisiting.
...
[CLAUDE.md](//CLAUDE.md)
 ...
 tells claude how to navigate the codebase. The feature 

[CLAUDE.md](//CLAUDE.md)

 tells claude how to work on this specific thing. The root file stays stable. The feature file evolves with the work.
...
It's very important that claude works on one small pieces at a time. Rule of thumb: every PR should take less than 10 minutes to review. I enforce this in the 
...
> The fun part is that claude runs the cookbooks, and stores the results in 
>
> [TESTING.md](//TESTING.md)
>
> . You think I'm kidding, check 
>
> [this out](https://github.com/agno-agi/agno/blob/main/cookbook/15_learning/testing.md)
>
> .
...
- Use Spec files. Symlink your specs folder in your codebase. 
...
- [CLAUDE.md](//CLAUDE.md)
   ...
   at two levels. Root level for the codebase, feature level for specific work.
