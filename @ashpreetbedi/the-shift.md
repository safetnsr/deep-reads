...
I badly transcribe a feature using whispr flow
Claude reviews the codebase, the `specs/` repo, then writes a design document from my loosely defined idea
I review everything. This is where most of my brainpower goes
I ask claude to implement a specific piece
I ask claude to write cookbooks and tests
Review what claude produces, ask it to test and improve
Iterate until correct
Claude updates implementation.md
