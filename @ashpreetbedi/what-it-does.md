...
Notes in text files. Bookmarks across three different browsers. People I meet (six or seven a day) living in my head until I forget them. Research I did last week that I cannot find anymore.
...
So I built Pal (Personal Agent that Learns).
...
[![](https://pbs.twimg.com/amplify_video_thumb/2016693383717412864/img/z2rBOXN_6GB3REiX.jpg)](blob:https://x.com/114fcfc6-05af-481e-9818-77d2ac548180)
...
[![](https://pbs.twimg.com/amplify_video_thumb/2016694164050890754/img/3Bjk1_HdHta9ESCB.jpg)](blob:https://x.com/4638cea2-5e11-4085-8643-9e5f6c4903b0)
...
[![](https://pbs.twimg.com/amplify_video_thumb/2016694843062587392/img/IiSLFWjpQL3zdHBy.jpg)](blob:https://x.com/fb077c00-ccc4-4084-9828-0b091fe797a1)
...
1. Pal has two storage systems (by design).
...
2. Pal creates tables on the fly. It spins up DuckDB tables for notes, bookmarks, people, meetings, research, and whatever else you end up needing. Nothing is pre-defined. It builds on the fly (lol good luck).
3. Pal learns continuously. It learns:
...
4. Pal compounds. The biggest advantage is that it improves its future behavior based on what worked and what broke. For example, if loading notes fails because a table is missing a primary key, it learns to create the notes table with a primary key by default next time.
...
[![](https://pbs.twimg.com/amplify_video_thumb/2016696362826633216/img/KhMMeHIjHy4Z4MZA.jpg)](blob:https://x.com/554e2ca2-fae3-4881-adf4-9607afa95375)
...
[![](https://pbs.twimg.com/amplify_video_thumb/2016701891695300611/img/4ENfrbXfTD6t7r0W.jpg)](blob:https://x.com/f8ab1255-1023-4425-bed1-0a120b4bc8a0)
...
[@ExaAILabs](https://x.com/@ExaAILabs)
 ...
 free MCP server - web search, company lookup, and people search out of the box. Thanks Exa 🙏

→ 

[GitHub repo with full code](https://github.com/agno-agi/agentos-railway-template)
