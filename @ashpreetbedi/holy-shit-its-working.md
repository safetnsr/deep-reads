...
Earlier this week I introduced 

[Learning Machines](https://x.com/ashpreetbedi/status/2008315658417647895)

 -- the idea that the next step for AI memory is learning from every interaction. [

[link to original post](https://x.com/ashpreetbedi/status/2008315658417647895)

]

Today I want to share some early experiments. What's working. What's not.

And one moment that made me stop and stare at my screen.
...
[![](https://pbs.twimg.com/tweet_video_thumb/G-DyDxxXMAEKU-h.jpg)](https://video.twimg.com/tweet_video/G-DyDxxXMAEKU-h.mp4)
...
```
User: "Hi! I'm Alice, I work at Anthropic as a research scientist.
I prefer concise responses without too much explanation."

The agent responds normally. Behind the scenes, it extracts:
name (Alice), company (Anthropic), role (research scientist),
preference (concise responses). The agent is learning about Alice.
```
...
```
User: "Hi! I'm Bob, a backend engineer at Stripe.
...
```
User A: "Always check cloud egress costs first -
they vary 10x between providers."
...
```
User B: "I'm picking a cloud provider for a 10TB daily data pipeline.
Key considerations?"
...
Session Context: tracks what's happening right now -- summary, goal, plan, progress. Use `session\_context=True` for lightweight continuity. Use `enable\_planning=True` when you need structured task tracking.
